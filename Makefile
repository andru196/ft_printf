...
#    Updated: 2019/06/26 19:21:34 by ycorrupt         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_strcapitalize.c ft_strndup.c get_next_line.c ft_utoa.c ft_mult.c ft_power_for_two.c ft_mult_atod.c ft_lstlen.c
...
all: $(NAME)
$(OBJ):
	@$(CC) -I $(HEADER) $(FLAGS) -c $(SRCS1) -g
	@$(CC) -I $(HEADER) $(FLAGS) -c $(SRCS2) -g
$(NAME): $(OBJ)
	@ar rc $(NAME) $(OBJ)
	@ranlib $(NAME)
